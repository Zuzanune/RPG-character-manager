...
database = {
    ...
    "test":{"simpleinfo":["Human", "Rogue", 1], "Items_Dictionary": {"Weapon": ["Dagger", "Weapon", "None"], "Armor": ["None", "Armor", "None"], "Inventory": []}, "skills":{("punch","The character can punch an enemy for damage")}, "attributes": [["strength", "dexterity", "intelligence", "wisdom", "constitution", "health", "armor class", "charisma"], [10, 10, 10, 10, 10, 10, 10, 10]]}}
